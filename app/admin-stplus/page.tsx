  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col md:flex-row font-sans">
      ...
      <aside
        ...
        md:sticky md:top-0 md:h-screen overflow-y-auto relative
      `}
      >
        ...
        {/* ปุ่มออกจากระบบ */}
        <div className="p-4 absolute bottom-0 w-full border-t border-gray-100 bg-white">
          <button
            onClick={handleLogout}
            className="flex items-center justify-center w-full gap-2 p-3 text-red-600 hover:bg-red-50 rounded-xl font-bold transition-colors"
          >
